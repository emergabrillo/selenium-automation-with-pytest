...
def test_add_and_remove_single_product_from_inventory_page(login_page, driver):
    # Perform login first
...
def test_add_and_remove_multiple_products_from_inventory_page(login_page, driver):
    # Perform login first
    login_page.enter_username("standard_user")
    login_page.enter_password("secret_sauce")
    login_page.click_login()
